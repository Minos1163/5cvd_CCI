...
| 2026-08-07-ATOM | 2026-08-07 | P0 | ATOM 牛市漏选修复:rank 扩围(25→90)+ LONG offset 校准(10→0)+ ATOM 入 targeted_long;目标 ATOM 08-02~08-05 多头段可选出并盈利 | configs/entry_chain.dry_run_fib_pa_v1.json + 分析脚本 | PENDING | 根因三层(符号层 rank83 排除/分数层 92 门槛不可达/闸门层 rr 2.0<4.0 降级);优化后 ATOM 回放 PROBE_OPEN 1 笔(08-02 09:45,87.3 分),单笔模拟 +1.44R;全宇宙候选 2/6天→19/4天;596 tests 通过;待 Claude 评审后部署 |
