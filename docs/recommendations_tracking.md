...
|---|---|---|---|---|---|---|
| 2026-08-02-TaskA | 2026-08-02 | P0 | 移除 q1_trend_launch 确认标签依赖,改位置质量约束(Q1 直接强结构通道) | scripts/run_live_dry_run.py:888 `_q1_trend_launch_eligible` | PENDING | 窗口内确认标签 0 次出现,通道零转化;本计划 Phase 2 修复中 |
...
| 2026-08-04-P0-1 | 2026-08-04 | P0 | q1_trend_launch 代码级修复:删 L888 标签 + 非极值追单检查(close 不在近8根极值最外20%) | scripts/run_live_dry_run.py L866-896 + src/signals/entry_chain_features.py extreme_position_ratio | IN_PROGRESS | 代码已修复:17 个单测通过,反事实验证解锁 5/33 高分 Q1 候选(追单样本被正确拦截);待部署后运行 verify_q1_trend_launch_fix.py --mode online 确认转化 |
...
| 2026-08-04-P0-3 | 2026-08-04 | P0 | 实施追踪协议(本表 + recommendation_tracker.py) | scripts/recommendation_tracker.py | IN_PROGRESS | 本计划 Phase 1 实施中 |
