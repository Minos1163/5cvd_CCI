...
|---|---|---|---|---|---|---|
| 2026-08-02-TaskA | 2026-08-02 | P0 | 移除 q1_trend_launch 确认标签依赖,改位置质量约束(Q1 直接强结构通道) | scripts/run_live_dry_run.py:888 `_q1_trend_launch_eligible` | DEPLOYED | 2026-08-04 已修复(commit 2e64232):标签依赖移除+非极值追单检查,17 单测+反事实 5/33 解锁;待部署后 verify --mode online 确认转化后转 VERIFIED |
