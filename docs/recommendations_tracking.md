...
| 2026-08-18-Q1TL | 2026-08-18 | P0 | q1_trend_launch 盈利化:SOL SHORT +6.25 样本(SOL +6.25/BNB -0.155,N=2 窗口) | 分析(评审后实施) | IN_PROGRESS | 按 08-18 小样本纪律:累计 7 笔 <10(08-24 窗口新增 4 笔 -1.31),仅记录不提炼特征/不资源倾斜;距 20 笔差 13;持续观察(每轮报告更新累计表) |
| 2026-08-24-SHORTBIAS | 2026-08-24 | P0 | confirmed bullish regime 下 SHORT 执行非对称审计 + regime_conditional_side_offset shadow(DEEPSEEK 3.3) | scripts/audit_bullish_regime_short_bias.py + scripts/regime_conditional_short_offset_shadow.py | DEPLOYED | 审计确认:bullish 窗口高分 SHORT 可执行率 16.67% vs LONG 4.12%(Q1 主导 19.64% vs 3.66%);shadow 反事实:SHORT 对称 offset +10 拦全部 12 笔高分 SHORT(16.67pp);live 门槛不变;设计+3 单测 |
